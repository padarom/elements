...
- [ ] Figure out xwayland-satellite issues (VCV Rack, DaVinci Resolve)
- [x] Screencasts
- [ ] Screenshot / Record videos
- [x] Cursor theme
- [ ] Shell/bar (See epik-shell)
- [x] Wallpapers
- [ ] Verify that games work
- [ ] `quick-zeal` should work
- [ ] `open-url` should work
- [x] `spawn-term` should work
- [ ] bash/zsh/fish/nu ?
